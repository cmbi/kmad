...
public:
	...
	//main functionality
	std::vector<std::string> performMSA(Profile&,double,double,std::string);
...
private:
	...
	void alignPairwise(std::string &,std::string &, std::string, Profile&, double, double, int,std::string);
