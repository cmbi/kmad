...
int main(int argc, char *argv[]){
	...
	double identityCutOff, gapExt, gapPen, endPenalty, lcr_mod;
	bool weightsModeOn;
	...
	desc.add_options()
		...
		("end,n", po::value<double>(&endPenalty)->default_value(0),"penalty for gaps at the end (and beginning)")
